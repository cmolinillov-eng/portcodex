...
export function LoginForm({ initialView = "login" }: LoginFormProps) {
        ...
        <div className="space-y-2">
          {profileChoices.map((p) => (
            <button
              ...
              className="flex w-full items-center justify-between rounded-xl border border-[rgba(47, 107, 255,0.15)] bg-black/30 px-4 py-3 text-left transition hover:border-[rgba(47, 107, 255,0.45)] hover:bg-[rgba(47, 107, 255,0.06)] disabled:opacity-60"
            >
              <span className="font-medium">{p.full_name ?? p.id.slice(0, 8)}</span>
              <span className="whitespace-nowrap text-xs text-[#2F6BFF]">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      {!isRecoveryMode ? (
        <div className="grid grid-cols-3 gap-2 rounded-xl border border-[rgba(47, 107, 255,0.12)] bg-[rgba(0,0,0,0.25)] p-1">
          <button
            type="button"
            onClick={() => setAuthView("login")}
            className={`rounded-lg px-2 py-1.5 text-xs transition ${
              authView === "login"
                ? "bg-[rgba(47, 107, 255,0.12)] text-[#A9D4BF]"
                : "text-[var(--muted)] hover:bg-[rgba(47, 107, 255,0.06)]"
            }`}
          >
            Iniciar sesión
          </button>
        ...
        <p className="rounded-lg border border-[rgba(47, 107, 255,0.2)] bg-[rgba(47, 107, 255,0.06)] px-3 py-2 text-sm text-[#A9D4BF]">
        ...
        <>
          <label className="block text-sm">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[rgba(47, 107, 255,0.15)] bg-black/30 px-3 py-2.5 text-sm outline-none transition-all duration-[400ms] ease-in-out focus:border-[rgba(47, 107, 255,0.55)] focus:ring-2 focus:ring-[rgba(47, 107, 255,0.1)] focus:shadow-[inset_0_0_0_1px_rgba(47, 107, 255,0.3),0_0_20px_rgba(29, 70, 184,0.12)]"
            />
          </label>
      ...
      {successMessage ? (
        <p className="rounded-lg border border-[rgba(47, 107, 255,0.45)] bg-[rgba(47, 107, 255,0.12)] px-3 py-2 text-sm text-emerald-300">
          {successMessage}
        </p>
      ) : null}
      ...
      <button
        ...
        className={`relative inline-flex w-full items-center justify-center overflow-hidden text-foreground transition duration-300 disabled:cursor-not-allowed disabled:opacity-60 ${
          isSubmitting
            ? "h-2 rounded-full bg-[rgba(29, 70, 184,0.15)] px-0 py-0"
            : "rounded-xl border border-[rgba(29, 70, 184,0.4)] bg-gradient-to-r from-[rgba(47, 107, 255,0.08)] to-[rgba(29, 70, 184,0.12)] px-4 py-3.5 text-[18px] font-medium transition-all duration-[400ms] ease-in-out hover:-translate-y-[2px] hover:from-[rgba(47, 107, 255,0.14)] hover:to-[rgba(29, 70, 184,0.2)] hover:shadow-[0_14px_30px_rgba(29, 70, 184,0.2)]"
        }`}
      >
        {isSubmitting ? (
