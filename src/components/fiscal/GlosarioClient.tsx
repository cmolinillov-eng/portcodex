    ...
    <div className="mx-auto max-w-4xl space-y-6 px-7 py-7">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-[var(--line)] bg-[var(--void-surface)] py-2.5 pl-9 pr-3 text-sm text-[var(--foreground)] placeholder:text-[var(--muted)] focus:border-[rgba(160,210,255,0.55)] focus:outline-none"
        />
      </div>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <h3 className="flex items-center gap-2 text-sm font-semibold text-[var(--foreground)]">
                  <BookOpen className="h-4 w-4 text-[#A0D2FF]" />
                  {t.term}
                </h3>
              ...
              {t.example ? (
                <p className="mt-3 rounded-lg border border-[rgba(160,210,255,0.18)] bg-[rgba(160,210,255,0.06)] px-3 py-2 text-xs leading-relaxed text-[var(--brand-soft)]">
                  <span className="font-medium text-[#A0D2FF]">Ejemplo · </span>
                  {t.example}
                </p>
              ) : null}
              {t.source ? (
    ...
    <button
      ...
      className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-colors ${
        active
          ...
          : "border-[var(--line)] bg-[var(--void-surface)] text-[var(--muted)] hover:border-[rgba(160,210,255,0.3)]"
      }`}
    >
      {label}
    </button>
