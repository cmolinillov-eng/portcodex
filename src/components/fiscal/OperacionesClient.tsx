    ...
    <div className="px-7 py-6">
      ...
      <div className="mb-5 flex flex-wrap items-center gap-3">
        <select
          ...
          className="rounded-lg border border-[var(--line)] bg-[var(--void-surface)] px-3 py-2 text-sm text-[var(--foreground)] focus:border-[rgba(111,174,143,0.55)] focus:outline-none"
        >
        ...
        <div className="relative min-w-[220px] flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[var(--line)] bg-[var(--void-surface)] py-2 pl-9 pr-3 text-sm text-[var(--foreground)] placeholder:text-[var(--muted)] focus:border-[rgba(111,174,143,0.55)] focus:outline-none"
          />
        </div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-[var(--line)] bg-[var(--void-surface)] px-3.5 py-2 text-sm text-[var(--foreground)] transition-colors hover:border-[rgba(111,174,143,0.45)] disabled:opacity-50"
        >
