      ...
      {portfolios.length > 0 ? (
        <div className="px-4 pb-4">
          ...
          <select
            ...
            className="w-full rounded-lg border border-[var(--line)] bg-[var(--void-elevated)] px-2.5 py-2 text-xs text-[var(--foreground)] focus:border-[var(--accent-primary)] focus:outline-none disabled:opacity-70"
          >
            {portfolios.map((p) => (
