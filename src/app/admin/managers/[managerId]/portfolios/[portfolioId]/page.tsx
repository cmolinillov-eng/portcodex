...
export default async function AdminManagerPortfolioPage({ params }: PageProps) {
  ...
  return (
    <>
      <div className="fixed top-3 left-1/2 z-50 -translate-x-1/2 rounded-xl border border-[rgba(47, 107, 255,0.45)] bg-[rgba(2,6,17,0.88)] px-4 py-2 backdrop-blur">
                ...
                return (
                  <Link
                    ...
                    className={`inline-flex rounded-md border px-2 py-1 ${
                      isActive
                        ? "border-[rgba(47, 107, 255,0.45)] bg-[rgba(47, 107, 255,0.14)] text-[#2F6BFF]"
