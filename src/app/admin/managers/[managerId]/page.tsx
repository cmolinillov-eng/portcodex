      ...
      <section className="page-content">
        ...
        <section className="card-premium page-section-card animate-fade-up stagger-2">
          <div className="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-[var(--glass-border)] bg-[rgba(47, 107, 255,0.05)] px-4 py-3">
            ...
            <div className="rounded-xl border border-[var(--glass-border)] bg-[rgba(47, 107, 255,0.05)] px-4 py-3">
              ...
              <p className="mt-1 text-xl font-semibold text-[#2F6BFF]">{rows.length}</p>
            </div>
          </div>
