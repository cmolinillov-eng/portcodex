...
export default async function ManagerPage() {
  ...
  return (
    <main className="page-shell">
      <div className="bg-orb -top-20 -left-20 h-72 w-72 bg-[rgba(47, 107, 255,0.22)]" aria-hidden="true" />
      <div className="bg-orb top-28 right-0 h-80 w-80 bg-[rgba(47, 107, 255,0.16)]" aria-hidden="true" />
      ...
      <section className="page-content">
        <header className="card-premium page-header-card self-start animate-fade-up">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="whitespace-nowrap rounded-full border border-[rgba(47, 107, 255,0.3)] bg-[rgba(47, 107, 255,0.08)] px-3 py-0.5 text-sm text-[#2F6BFF]">{managerLabel}</span>
            </div>
        ...
        <section className="card-premium page-section-card animate-fade-up stagger-2">
          <div className="section-header-row mb-5 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="rounded-xl border border-[var(--glass-border)] bg-[rgba(47, 107, 255,0.05)] px-4 py-2 text-center">
              <p className="text-[10px] uppercase tracking-[0.18em] text-[var(--muted)]">Portfolios gestionados</p>
              <p className="text-lg font-semibold text-[#2F6BFF]">{rows.length}</p>
            </div>
          </div>
